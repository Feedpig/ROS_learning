...
// (in-package plumbing_client_server.srv)
...
class AddientRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddientRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddientRequest
    let len;
    let data = new AddientRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddientRequest(null);
...
class AddientResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddientResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddientResponse
    let len;
    let data = new AddientResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddientResponse(null);
...
module.exports = {
  Request: AddientRequest,
  Response: AddientResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'plumbing_client_server/Addient'; }
};
